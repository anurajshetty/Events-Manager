...
while($row = mysqli_fetch_array($stmt)) {
   ...
   echo "<tr><td>$row[1]</td><td>$row[2]</td><td>$row[3]</td><td>$row[4]</td><td>$row[5]</td><td>$row[6]</td><td>$row[7]</td><td><input style='height:40px;width:100px;' type='button' class='button_report1' id='$row[0]' value='Add' onclick='showdata(this)'></td></tr>";
   $flag1=1;
